...
def generateConfig(name,src):
    ...
    if os.path.isfile('/home/nguyenhung/Desktop/'+ name + '.yaml'):
        os.remove('/home/nguyenhung/Desktop/'+ name + '.yaml')

    with open('/home/nguyenhung/Desktop/'+ name + '.yaml', 'w') as outfile:
        try:
            # setup_yaml()
